...
class StudentsApiView(ListModelMixin, CreateModelMixin, GenericAPIView):
...
class StudentDataView(RetrieveModelMixin, UpdateModelMixin, DestroyModelMixin, GenericAPIView):
    queryset = Student.objects.all()
    serializer_class = StudentSerializer
